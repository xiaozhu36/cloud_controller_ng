...
#
#   RSpec.describe OrganizationAccess, type: :access do
#     subject { OrganizationAccess.new(Security::AccessContext.new) }
#
#     let(:user) { VCAP::CloudController::User.make }
#     let(:org) { VCAP::CloudController::Organization.make(billing_enabled: false) }
#     let(:object) { org }
#
#     index_table = {
...
#
#     describe '#read_for_update' do
#       context 'with billing_enabled set' do
#         read_for_update_table = {
#           unauthenticated: false,
#           reader_and_writer: false,
#           reader: false,
#           writer: false,
...
#         }
#
#         let(:op_params) { { billing_enabled: true } }
#
#         it_behaves_like('an access control', :read_for_update, read_for_update_table)
#       end
#
#       context 'without billing_enabled set' do
#         read_for_update_table = {
#           unauthenticated: false,
#           reader_and_writer: false,
#           reader: false,
